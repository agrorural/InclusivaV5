<section id="social" class="section">
    ...
    <script>(function(d, s, id) {
      ...
      js.src = 'https://connect.facebook.net/es_ES/sdk.js#xfbml=1&version=v3.0&appId=485149758350535&autoLogAppEvents=1';
      ...
      <div class="col socialItem youtube">
        <div class="item-container">
            ...
            <header class="embed-responsive">
              <div class="g-ytsubscribe" data-channel="pnmsperu" data-layout="full" data-count="default"></div>
            </header>
            <footer class="d-none d-lg-block">
              <picture>
                <img src="@asset('images/social__yt__bg.jpg')" class="img-fluid">
              </picture>
            </footer>
        </div>
      </div>
