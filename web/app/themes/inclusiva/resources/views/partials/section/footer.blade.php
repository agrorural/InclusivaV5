    ...
    <div class="container">
      <div class="row">
        <section class="widget widget_brand">
            <a href="{{ home_url('/') }}">
              <svg version="1.1" id="agro_rural__logo" class="light" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 250 91.2" xml:space="preserve" width="150px" height="55px">
                <g id="leafs">
        ...
        <section class="widget widget_footer_menu">
            {{-- @if (has_nav_menu('primary_navigation'))
                {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'depth' => 0, 'container' => 'nav', 'container_id' => 'footer_navigation', 'menu_class' => 'nav flex-column', 'fallback_cb' => 'WP_Bootstrap_Navwalker::fallback', 'walker' => new WP_Bootstrap_Navwalker()]) !!}
            @endif --}}
        </section>

        <section class="widget widget_forms_menu widget_social_menu">
            @if (has_nav_menu('forms_navigation'))
                {!! wp_nav_menu(['theme_location' => 'forms_navigation', 'depth' => 0, 'container' => 'nav', 'container_id' => 'forms_navigation', 'menu_class' => 'nav flex-column', 'fallback_cb' => 'WP_Bootstrap_Navwalker::fallback', 'walker' => new WP_Bootstrap_Navwalker()]) !!}
            @endif
            @if (has_nav_menu('social_navigation'))
                {!! wp_nav_menu(['theme_location' => 'social_navigation', 'depth' => 0, 'container' => 'nav', 'container_id' => 'social_navigation', 'menu_class' => 'nav', 'fallback_cb' => 'WP_Bootstrap_Navwalker::fallback', 'walker' => new WP_Bootstrap_Navwalker()]) !!}
            @endif
        </section>
      </div>
    </div>
